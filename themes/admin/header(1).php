...
<body class='<?php if($user['admin_theme'] == 2){ echo 'dark-mode'; } ?>' oncopy="return false" oncut="return false" onpaste="return false">
...
if( $user['admin_theme'] == 2 ):
    echo "<li><a href='https://smmcode.net/item/perfect-panel-smm-panel-script' data-toggle='modal' ><img src='https://d.top4top.io/p_2300sztz71.png' width='20' height='20'></a></li>";
else:
    echo "<li><a href='https://smmcode.net/item/perfect-panel-smm-panel-script' data-toggle='modal' ><img src='https://d.top4top.io/p_2300sztz71.png' width='20' height='20'></a></li>";
endif;
...
<li><a href='<?php echo site_url('logout') ?>'>sign out </a></li></ul>        
</div>
</div>
