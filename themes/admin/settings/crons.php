    ...
    <div class="panel panel-default">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" disabled value="<?= URL."/wpclasses.php?token=". $keys_key_moto?>">
            </div>
            <div class="col-md-12 help-block">
                <small><i class="fa fa-warning"></i> <code>Cron Key</code> Type your API Key in the password section for.</small>
