...
$crons_details = $conn->prepare("SELECT * FROM crons  Order By sort_num asc");
     ...
     /*******************************************************************************************************************/
      ...
      if($cron['cron_id'] == 4){
        ...
        if($update){
            ...
            $report = $report->execute(array("crons_service_name"=>$cronname, "crons_detail"=>$cronname." cron ".date("d.m.Y H:i:s"). " was run on." ));
