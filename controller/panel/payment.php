...
exit;
    ...
    $secret_key = $extra['secret_key'];
          ...
          require_once($_SERVER['DOCUMENT_ROOT']."/lib/webmoney/webmoney.inc.php");
    ...
    'amount'=> $amount,
        ...
        */
        ...
        if (200 != $httpStatusCode) {
         ...
         $result_2 = $response?$response:null;
        $result_2 = json_decode($result_2,true);

        $payment_success = @$result['state']['name'] == 'Completed' && $result_2['status'] == true && $result_2['state'] == 'Complete'  ? true : false;
